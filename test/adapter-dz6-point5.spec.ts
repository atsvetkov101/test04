...
import { AdapterGenerator } from '../src/adapter/adapter-generator';
...
describe('Тесты для адаптера', function() {
  describe('Набор тестов для адаптера', function() {
    ...
    it('DZ6 point 5 IoC регистрируем и используеи адаптер. Создаем экземпляр динамического класса с методом finish.', function() {
